...
export default function Register() {
  ...
  const fields = [
    { name: "firstName", label: "First name", type: "text", placeholder: "Jamie", autoComplete: "given-name" },
    { name: "lastName", label: "Last name", type: "text", placeholder: "Kim", autoComplete: "family-name" },
    { name: "username", label: "Username", type: "text", placeholder: "jamie.kim", autoComplete: "username", icon: <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" /> },
                ...
                <div key={name}>
                  ...
                  <div className={`relative rounded-xl border transition-all duration-150 ${focused === name ? "border-stone-400 shadow-sm ring-2 ring-stone-900/5" : "border-stone-200"} bg-white`}>
                    ...
                    <input
                      ...
                      className="w-full pl-4 pr-3 py-3 bg-transparent text-stone-900 placeholder-stone-400 text-sm rounded-xl focus:outline-none"
                    />
                  </div>
                </div>
              ))}
