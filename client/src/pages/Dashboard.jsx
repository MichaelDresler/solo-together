    ...
    <main className="w-full p-6">
      <div className="mx-auto max-w-6xl space-y-8">
        <section className=" ">
          ...
          <div className="mt-6 mb-24 flex gap-3">
            <Link
              to="/discover"
              className="rounded-full squircle bg-amber-700 px-5 py-3 text-sm font-semibold text-white transition hover:bg-amber-800"
            >
              Discover more events
            </Link>
            <Link
              to="/profile"
              className="rounded-full squircle border border-stone-300 px-5 py-3 text-sm font-semibold text-stone-700 transition hover:bg-stone-50"
            >
              View your profile
            </Link>
          </div>
